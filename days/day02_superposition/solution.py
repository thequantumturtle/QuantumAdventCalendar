...
Challenge: Create a 2-qubit circuit in equal superposition using Hadamard gates,
measure both qubits, and verify that the four basis states appear roughly equally.
"""
